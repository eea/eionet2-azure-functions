...
app.http('UserRemoval', {
    ...
    handler: async (request, context) => {
        ...
        try {
            ...
            if (config) {
                ...
                if (result && !applyRemove) {
                    ...
                    return { body: `Function UserRemoval executed successfully. No user was removed. User available for delete: ${stringResult}.`, status: 200 };
                } else if (applyRemove) {
                    return { body: `Function UserRemoval executed successfully. The removed users were logged in the Logging list`, status: 200 };
                }
            }
        } catch (err) {
        ...
        return { body: `Function UserRemoval executed successfully. No users available fore removal`, status: 200 };
    },
});